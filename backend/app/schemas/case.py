...
class CaseBase(BaseModel):
    ...
    code: str = Field("", max_length=100, description="用例编号")
    precondition: str = Field(..., min_length=1, description="预置条件")
...
class CaseUpdate(BaseModel):
    ...
    code: str | None = Field(None, max_length=100, description="用例编号")
    precondition: str | None = Field(None, min_length=1, description="预置条件")
